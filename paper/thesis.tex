...
% The call to \usepackage[margin=1in]{geometry} breaks the margins set in
% ulthesis.cls. For now, I think it's best to just remove base-cfg and manually
% add packages I need here in this document.
%\input{base-cfg.tex}
\input{programming-cfg.tex}
...
\newcommand{\ib}{InfiniBand}
\newcommand{\gbps}{\giga\bit\per\second}
\newcommand{\edr}{\qty{100}{\gbps}}
\newcommand{\hdr}{\qty{200}{\gbps}}
...
%============================= Custom Environments =============================
% cverb environment for formatting binary numbers centered, similar to equations
\newenvironment{cverb}{\begin{center}\ttfamily}{\end{center}}

% binary environment for formatting binary numbers centered, similar to
% equations
\newenvironment{binary}{\begin{cverb}}{\end{cverb}}
